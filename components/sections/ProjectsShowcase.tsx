...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl overflow-hidden bg-white/5 dark:bg-black/20 border border-white/20 shadow-xl hover:shadow-2xl hover:shadow-azure-500/20 transition-all duration-300"
