        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            ...
            >
              ...
              >
                <div className="relative p-6 rounded-2xl bg-white/5 dark:bg-black/20 border border-white/20 shadow-xl hover:shadow-2xl hover:shadow-azure-500/20 transition-all duration-300">
                  {/* Period Badge */}
                  <div
